...
/**
 * İstatistikler bölümü. Arka planda çok silik, dekoratif (statik) bir Türkiye
 * silüeti; önünde stats.ts'ten beslenen, scroll'a girince stagger ile beliren
 * kartlar. Mobil performansı için sürekli (sonsuz) animasyon kullanılmaz.
 */
export function StatsSection({ stats }: { stats: Stat[] }) {
  return (
    <section className="relative overflow-hidden bg-ice/10 py-20">
      {/* Dekoratif arka plan silüeti — statik (animasyonsuz). */}
      <svg
